...
<div id="wpfc-image-static-panel" style="width:100%;float:left;">
	<div style="float: left; width: 100%;">
		...
		<div id="wpfc-statics-right" style="float: left;padding-left:12px;">
			...
			<ul style="list-style: none outside none;float: left;">
				<li>
					<h1 style="margin-top:0;float:left;padding-top: 0;">Credit: <span class="wpfc-loading-statics" id="wpfc-optimized-statics-credit" style="display: inline-block; height: 16px; width: auto;min-width:25px;"></span></h1>
